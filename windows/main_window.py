...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.result_truck_name_combo_box = QtWidgets.QComboBox(self.tab_2)
        self.result_truck_name_combo_box.setObjectName("result_truck_name_combo_box")
        self.horizontalLayout_7.addWidget(self.result_truck_name_combo_box)
        self.result_show_trucktimes_button = QtWidgets.QPushButton(self.tab_2)
        self.result_show_trucktimes_button.setObjectName("result_show_trucktimes_button")
        self.horizontalLayout_7.addWidget(self.result_show_trucktimes_button)
        self.result_show_truckgoods_button = QtWidgets.QPushButton(self.tab_2)
        self.result_show_truckgoods_button.setObjectName("result_show_truckgoods_button")
        self.horizontalLayout_7.addWidget(self.result_show_truckgoods_button)
        self.gridLayout.addLayout(self.horizontalLayout_7, 3, 0, 1, 1)
        self.horizontalLayout_5 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_5.setObjectName("horizontalLayout_5")
        self.result_solution_name_combo_box = QtWidgets.QComboBox(self.tab_2)
        self.result_solution_name_combo_box.setObjectName("result_solution_name_combo_box")
        self.horizontalLayout_5.addWidget(self.result_solution_name_combo_box)
        self.label_4 = QtWidgets.QLabel(self.tab_2)
        self.label_4.setObjectName("label_4")
        self.horizontalLayout_5.addWidget(self.label_4)
        self.result_Iteration_number_line_edit = QtWidgets.QLineEdit(self.tab_2)
        ...
        self.result_show_best_solution_button = QtWidgets.QPushButton(self.tab_2)
        self.result_show_best_solution_button.setObjectName("result_show_best_solution_button")
        self.horizontalLayout_5.addWidget(self.result_show_best_solution_button)
        ...
        self.result_show_all_errors_button = QtWidgets.QPushButton(self.tab_2)
        self.result_show_all_errors_button.setObjectName("result_show_all_errors_button")
        self.horizontalLayout_6.addWidget(self.result_show_all_errors_button)
        self.result_show_errors_button = QtWidgets.QPushButton(self.tab_2)
        self.result_show_errors_button.setObjectName("result_show_errors_button")
        self.horizontalLayout_6.addWidget(self.result_show_errors_button)
        self.result_show_sequences_button = QtWidgets.QPushButton(self.tab_2)
        self.result_show_sequences_button.setObjectName("result_show_sequences_button")
        self.horizontalLayout_6.addWidget(self.result_show_sequences_button)
        ...
        self.gridLayout.setRowMinimumHeight(4, 5)
        ...
        self.run_simulation_button = QtWidgets.QPushButton(self.tab_4)
        self.run_simulation_button.setObjectName("run_simulation_button")
        self.horizontalLayout_2.addWidget(self.run_simulation_button)
        self.simulation_reset_button = QtWidgets.QPushButton(self.tab_4)
        self.simulation_reset_button.setObjectName("simulation_reset_button")
        self.horizontalLayout_2.addWidget(self.simulation_reset_button)
        ...
        self.gridLayout_6 = QtWidgets.QGridLayout(self.simulationFrame)
        self.gridLayout_6.setObjectName("gridLayout_6")
        self.simulationGrid = QtWidgets.QGridLayout()
        self.simulationGrid.setObjectName("simulationGrid")
        self.gridLayout_6.addLayout(self.simulationGrid, 0, 0, 1, 1)
        self.gridLayout_5.addWidget(self.simulationFrame, 1, 0, 1, 1)
        ...
        self.enterSequenceButton.setCurrentIndex(2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_5.setText(_translate("MainWindow", "Time Limit:"))
        self.solve_data_set_button.setText(_translate("MainWindow", "Run"))
        self.label_12.setText(_translate("MainWindow", "Times"))
        self.label_6.setText(_translate("MainWindow", "Data Set Number:"))
        self.stop_data_set_solve_button.setText(_translate("MainWindow", "Stop"))
        self.result_show_trucktimes_button.setText(_translate("MainWindow", "Show Truck Times"))
        self.result_show_truckgoods_button.setText(_translate("MainWindow", "Show Finish Goods"))
        self.label_4.setText(_translate("MainWindow", "Itereation  Number"))
        self.result_show_best_solution_button.setText(_translate("MainWindow", "Show Best Solution"))
        self.result_show_all_errors_button.setText(_translate("MainWindow", "Show Objective Function Results For All Iterations"))
        self.result_show_errors_button.setText(_translate("MainWindow", "Show Objective Function Results For Iteration"))
        self.result_show_sequences_button.setText(_translate("MainWindow", "Show Current Sequences"))
        ...
        self.run_simulation_button.setText(_translate("MainWindow", "Run"))
        self.simulation_reset_button.setText(_translate("MainWindow", "Reset"))
